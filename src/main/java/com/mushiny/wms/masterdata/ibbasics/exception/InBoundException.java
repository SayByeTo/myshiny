package com.mushiny.wms.masterdata.ibbasics.exception;

public enum InBoundException {

    /**
     * IN BOUND ENTITY EXCEPTION
     **/
    EX_MD_IN_RECEIVE_CATEGORY_NAME_UNIQUE,// 过滤规则:{0}已存在!

    EX_MD_IN_RECEIVE_CATEGORY_RULE_NAME_UNIQUE,// 规则:{0}已存在!

    EX_MD_IN_RECEIVE_DESTINATION_NAME_UNIQUE,// 目的地:{0}已存在!

    EX_MD_IN_RECEIVE_STATION_NAME_UNIQUE,// 工作站:{0}已存在!

    EX_MD_IN_RECEIVE_STATION_TYPE_NAME_UNIQUE,// 工作站类型:{0}已存在!

    EX_ITEM_DATA_TYPE_GRADE_STATS_ITEM_DATA_UNIQUE,// SKU:{0}已存在!

    EX_MD_IN_REPLENISH_STRATEGY_UNIQUE,// 补充策略已存在!

    EX_MD_IN_RECEIVE_THRESHOLD_NAME_UNIQUE,// 类型:{0}已存在!

    EX_MD_IN_STOW_STATION_NAME_UNIQUE,// 类型:{0}已存在!
    ...
    EX_MD_IN_IBP_STATION_NAME_UNIQUE,

    EX_MD_IN_IBP_STATION_TYPE_NAME_UNIQUE,

    EX_MD_IN_WORKSTATION_NOT_FOUND,

    EX_MD_IN_STOCKING_TAKING_STATION_NAME_UNIQUE,

    EX_MD_IN_STOCK_TAKING_STATION_TYPE_NAME_UNIQUE,
